    ...
    >
      ...
      <section className="space-y-6 text-lg text-gray-800 leading-relaxed">
        {[
          ...
          `Founded by Er. Harinder Jain, are ISO 9001:2015 certified company, designs and supplies Solar Photovoltaic Systems, Solar Water Heaters, Solar Thermal Systems, Wind Generators, and complete Solar Power Plants.`,
