      ...
      <div className="bg-white shadow-2xl rounded-lg p-10 w-full max-w-4xl">
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col">
            ...
            <input type="text" className="border p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" />
          </div>
          ...
          <div className="flex flex-col">
            ...
            <input type="email" className="border p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" />
          </div>

          <div className="flex flex-col md:col-span-2">
            <label className="font-semibold mb-2">Products (Hold Ctrl to select multiple)</label>
            <select multiple className="border p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 h-40">
          ...
          <div className="flex flex-col md:col-span-2">
            ...
            <textarea rows="5" className="border p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"></textarea>
          </div>
          ...
          <div className="flex gap-4 justify-center md:col-span-2 mt-6">
            ...
            <button type="reset" className="bg-gray-300 hover:bg-gray-400 text-black font-bold py-3 px-8 rounded-full transition duration-300">
              Reset
            </button>
          </div>
        </form>
