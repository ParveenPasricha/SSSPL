...
const Header = ({ isLoggedIn, handleLogout }) => {
  ...
  return (
    <header className="bg-gradient-to-br from-blue-100 via-white to-blue-50 shadow-lg px-6 md:px-12 py-5 rounded-lg border border-blue-200" style={{ fontFamily: 'Times New Roman, Times, serif' }}>
      ...
      <h1 className="text-5xl md:text-5xl flex items-center justify-center font-extrabold text-blue-700 mb-4 tracking-wide">
        ...
        <span className="text-blue-500 text-6xl  ">Su Solartech Systems (P) Ltd.</span>
      </h1>
